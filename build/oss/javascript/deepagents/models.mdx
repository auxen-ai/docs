...
Open-weight models are available through providers like [OpenRouter](/oss/javascript/integrations/chat/openrouter),  or [Ollama](/oss/javascript/integrations/chat/ollama).
